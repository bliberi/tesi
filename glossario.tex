...
\newglossaryentry{agile}
{
    ...
    text=agile,
    sort=agile,
    description={In ingegneria del software, è un insieme di metodi di sviluppo del software emersi a partire dai primi anni 2000 e fondati su insieme di principi comuni, direttamente o indirettamente derivati dai principi del \citetitle{manifesto}. Tale manifesto si può riassumere in quattro punti:
        \begin{enumerate}
